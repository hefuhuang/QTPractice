...
QT_MOC_LITERAL(4, 25, 4) // "date"

    },
    "Newspaper\0NewPaper\0\0name\0date"
};
...
void Newspaper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->NewPaper((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QDate(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (Newspaper::*_t)(const QString & , const QDate & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Newspaper::NewPaper)) {
                *result = 1;
                return;
            }
...
// SIGNAL 1
void Newspaper::NewPaper(const QString & _t1, const QDate & _t2)
{
