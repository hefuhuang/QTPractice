...
struct qt_meta_stringdata_CustomButtonEx_t {
    QByteArrayData data[1];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CustomButtonEx_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CustomButtonEx_t qt_meta_stringdata_CustomButtonEx = {
    {
QT_MOC_LITERAL(0, 0, 14) // "CustomButtonEx"
...
static const uint qt_meta_data_CustomButtonEx[] = {
...
void CustomButtonEx::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject CustomButtonEx::staticMetaObject = {
    { &CustomButton::staticMetaObject, qt_meta_stringdata_CustomButtonEx.data,
      qt_meta_data_CustomButtonEx,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *CustomButtonEx::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *CustomButtonEx::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_CustomButtonEx.stringdata0))
        return static_cast<void*>(const_cast< CustomButtonEx*>(this));
    return CustomButton::qt_metacast(_clname);
}

int CustomButtonEx::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
